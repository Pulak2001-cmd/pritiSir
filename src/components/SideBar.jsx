  ...
  return (
    <div className="d-flex flex-column bg-dark p-3" style={{minHeight: '100vh'}}>
        ...
        <ul style={{color: '#fff', listStyle: 'none'}}>
            ...
            <Link className="nav-link" onClick={()=> setCurrPage('people')} to="/people"><li style={{borderBottom: '0.5px solid #ccc', padding: 5, cursor: 'pointer', fontWeight: `${currPage === 'people' ? 'bold':'normal'}`}}>People</li></Link>
            <Link className="nav-link" onClick={()=> setCurrPage('courses')} to="/courses"><li style={{borderBottom: '0.5px solid #ccc', padding: 5, cursor: 'pointer', fontWeight: `${currPage === 'courses' ? 'bold':'normal'}`}}>Courses</li></Link>
